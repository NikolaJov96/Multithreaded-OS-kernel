...
void setupRoutine(int id, InterruptRoutine routine, IVTEntry *entry);	// Bounds prepared static methot (sets new interrupt routine)
...
#define PREPAREENTRY(id,oldRoutine)\
	...
	{\
		public:\
			IVTEntry_##id(){\
				setupRoutine(id, (InterruptRoutine)execute, this);\
			}\
	...
	IVTEntry_##id *entry_##id = new IVTEntry_##id();
